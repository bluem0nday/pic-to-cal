...
If neither search attempt returned a usable URL, or if the page wouldn't load, continue to step 7 with no URL. The HOLD will get an "unverified source" flag in the description. Don't ask the user whether to proceed — the BACKLOG decision is auto-skip after two tries.
